...
if __name__ == "__main__":
    ...
    for dataset, input_paths in query_folder_dict.items():
        for idx, input_query_path in enumerate(input_paths):
            ...
            qwen_cot_generate.handle_file(input_query_path, input_retrieval_folder, output_file_path, dataset, language, query_key="question") # (input_query_path, input_retrieval_folder, output_file_path, dataset_name, query_key=["question", "QUESTION", "rewritten_query"])