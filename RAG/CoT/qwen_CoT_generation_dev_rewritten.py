        ...
        with open(input_query_path, "r", encoding="utf-8", errors="ignore") as fin, open(
            ...
            for idx, line in enumerate(fin):
                try:
                    ...
                    retrieval_list = []
                    retrieval_path = Path(input_retrieval_folder + query_key + f"/result_{str(index)}.jsonl")
                    if retrieval_path.is_file(): # 判断当前文件是否存在
                        ...
                        print(f"File not found: {retrieval_path}")
...
def get_pubmedqa_index():
    pubmedqa_path = "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/benchmark/pubmedqa/data/ori_pqal.json"
    pubmedqa_idx_list = []
...
if __name__ == "__main__":
    retrieval_folder_dict = { # original retrieved documents
        "MedQA": [
            ...
            # "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query/output/MedQA/Mainland/dev/",
            # "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query/output/MedQA/Mainland/test/",
            "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query/output/MedQA/US/dev/",
            "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query/output/MedQA/US/test/"
        ],
        "MedMCQA": [
    ...
    query_folder_dict = { # rewritten
        "MedQA": [
            ...
            # "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query_rewriting/output/MedQA/Mainland/dev.jsonl",
            # "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query_rewriting/output/MedQA/Mainland/test.jsonl",
            "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query_rewriting/output/MedQA/US/dev.jsonl",
            "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/query_rewriting/output/MedQA/US/test.jsonl",
        ],
        "MedMCQA": [
    ...
    output_root_folder = "/cpfs/29f69eb5e2e60f26/code/sft_intern/keerlu/medical_RAG/RAG/CoT/output/"
