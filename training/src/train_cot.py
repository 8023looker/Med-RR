...
class SupervisedDataset(Dataset):
    ...
    def __init__(self, data_path: str, tokenizer: transformers.PreTrainedTokenizer):
        ...
        list_data_dict = utils.jload_medical_cot(data_path, dataset_name, query_path)

        logging.warning("Formatting inputs...")
        prompt_medqa, prompt_medmcqa, prompt_pubmedqa = PROMPT_DICT["prompt_medqa"], PROMPT_DICT["prompt_medmcqa"], PROMPT_DICT["prompt_pubmedqa"]
        # sources = [
        ...
        # ]
        sources = [
            prompt_medqa.format_map(example) if dataset_name == "MedQA" else (prompt_medmcqa.format_map(example) if dataset_name == "MedMCQA" else prompt_pubmedqa.format_map(example))
            for example in list_data_dict
        ]
